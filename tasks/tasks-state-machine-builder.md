...
- [ ] 1.0 Set up CI/CD pipeline with GitHub Actions
  - [ ] 1.1 Create `.github/workflows/ci.yml` with trigger on pull requests and pushes to main
  - [ ] 1.2 Configure workflow to restore, build, and run `dotnet test` for all test projects
